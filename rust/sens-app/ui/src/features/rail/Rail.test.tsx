...
beforeEach(() => {
  ...
  profile.setState({ person: { name: "Ada Lovelace", checkUpdates: true, welcomed: true, seen: "" }, fault: "" });
...
describe("the rail", () => {
  ...
  it("shows who uses Sens, with a menu to settings, shortcuts and about", async () => {
    ...
    act(() => profile.setState({ person: { name: "", checkUpdates: true, welcomed: true, seen: "" } }));
